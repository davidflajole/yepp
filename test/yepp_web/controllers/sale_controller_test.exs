defmodule YeppWeb.SaleControllerTest do
  use YeppWeb.ConnCase

  import Yepp.AuctionFixtures

  @create_attrs %{name: "some name", start: ~N[2023-11-19 01:00:00], status: "some status", description: "some description", end: ~N[2023-11-19 01:00:00]}
